...
export class MerchantDeleteComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<MerchantDeleteComponent>,
  ...
  deleteRowData(): any {
    ...
    if (this.row) {
      ...
      this.manageGridService.deleteRowData(ModuleKeyModel.merchant.key, params).subscribe((response) => {
